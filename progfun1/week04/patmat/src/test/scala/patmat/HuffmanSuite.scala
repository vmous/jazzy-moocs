...
class HuffmanSuite extends FunSuite {
  ...
  test("times of [a,b,a,c,b]") {
    assert(times(List('a','b','a','c','b')).toSet === List(('a',2),('b',2),('c',1)).toSet)
  }
  ...
  test("times of a longer word") {
    assert(times(string2Chars("some-longer-and-weird-word-wtf")).toSet
      === List(('s',1),('o',3),('m',1),('e',3),('-',5),('l',1),('n',2),('g',1),('r',3),('a',1),('d',3),('w',3),('i',1),('t',1),('f',1)).toSet)
  }
