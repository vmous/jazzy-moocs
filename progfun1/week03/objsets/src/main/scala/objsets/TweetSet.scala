...
class Tweet(val user: String, val text: String, val retweets: Int) {
  ...
  def compareRetweets(that: Tweet): Tweet = {
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def union(that: TweetSet): TweetSet = {
    ...
    // Check explanation in
    // https://www.coursera.org/learn/progfun1/discussions/weeks/3/threads/AzJ-4CLYEeag6wpD-92Rcw/replies/ZmrCpCNPEearfA7hVcWeXw/comments/l-gKliPdEeaPqRI66g-Cyw
  ...
  def mostRetweetedAcc(acc: Tweet): Tweet = {
    left.mostRetweetedAcc(right.mostRetweetedAcc(elem.compareRetweets(acc)))
  }
